    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api Ryudev - an awesome FREE REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6285745446417">WhatsApp</a></span></span>
            <span style="display: block;"><br>Regards,<br>Ryudev</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"Ryudev" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api Ryudev`,
        html: inboxGmail,
      };
